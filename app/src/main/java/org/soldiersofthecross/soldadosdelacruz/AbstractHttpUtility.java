 ...
 */
public abstract class AbstractHttpUtility implements IHttpUtility {

    // instantiating the async http client
    ...
    public void putEndpoint(String endpoint, RequestParams params) {
        client.put(endpoint, params, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
